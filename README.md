...
### Documentação:
 ...
 - Artigo 01: [JAVA: A importância da precisão nos dados](https://medium.com/@atom.free/java-02-f31f913b46c9?postPublishedType=repub)
    - Código 01: [Tipos Primitivos](https://github.com/Motatom0101/curso-desenvolvimento-java/blob/main/src/tiposprimitivos/TiposPrimitivosNotasEstudos.java)
    - Código 02: [Variáveis](https://github.com/Motatom0101/curso-desenvolvimento-java/blob/main/src/variaveis/VariaveisNotasEstudo.java)
